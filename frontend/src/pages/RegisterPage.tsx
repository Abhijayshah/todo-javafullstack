...
import { CheckSquare, Lock, Mail, User as UserIcon, ArrowRight, AlertCircle, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">Join the full stack task management platform</p>
        </div>
